...
CREATE TABLE `atraccion_turistica` (
  `id` int(11) NOT NULL,
  `n_atraccion` varchar(40) NOT NULL,
...
INSERT INTO `atraccion_turistica` (`id`, `n_atraccion`, `id_municipio`, `celular`) VALUES
(2, 'paseo en lancha', 249, '3234333'),
(3, 'paseo en ciudad', 171, '323432233'),
(4, 'paseo en ciudad', 57, '32343333'),
(5, 'paseo en ciudad', 791, '32342233'),
(6, 'paseo en ciudad', 877, '32342113');
...
CREATE TABLE `detalle_persona_paquete` (
  ...
  `estado` enum('activo','reservado','terminado','cancelado') NOT NULL,
...
CREATE TABLE `paquete_turistico` (
  ...
  `id_restuarante` int(11) NOT NULL,
  `id_atraccion_turistica` int(11) NOT NULL,
  `id_transporte` int(11) NOT NULL,
  `precio_dia` int(20) NOT NULL,
  `numero_dias` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `paquete_turistico` (`id`, `nombre`, `clase`, `descripcion`, `id_municipio`, `id_hotel`, `id_restuarante`, `id_atraccion_turistica`, `id_transporte`, `precio_dia`, `numero_dias`) VALUES
(2, 'coveñas', 'PREMIUN', 'el paquete es uno de los mas vendido', 249, 3, 1, 2, 3, 100000, 4),
(3, 'paquete basico', 'BASICO', 'este paquete cuenta con ....', 171, 5, 3, 3, 5, 120000, 5),
(4, 'arboletes lite', 'LITE', 'este paqyeuete  .... ', 57, 6, 5, 4, 7, 200000, 5),
(5, 'san antero promocional', 'PROMOCIONAL', 'este paque es de promocion disfruta de ...\r\njuhy', 791, 4, 7, 5, 9, 168000, 7),
(6, 'santa marta premiun', 'PREMIUN', 'este paquete cuenta con ....', 877, 7, 9, 6, 11, 176000, 9);
...
(6, 'transfort', 171, '32123222'),
(7, 'taxiterco', 57, '45433332'),
(8, 'transvalor', 57, '32144222'),
(9, 'transjose', 791, '4543332'),
(10, 'transdavidr', 791, '32143222'),
(11, 'taxi san jose', 877, '45454332'),
(12, 'transhtv', 877, '32143222');
...
ALTER TABLE `paquete_turistico`
  ...
  ADD KEY `id_restuarante` (`id_restuarante`),
...
--
ALTER TABLE `usuario`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Esta es la id del tipo de usuario que va a tener l sistema', AUTO_INCREMENT=9;
...
ALTER TABLE `paquete_turistico`
  ...
  ADD CONSTRAINT `fk_restaurante-id-restaurante` FOREIGN KEY (`id_restuarante`) REFERENCES `restaurante` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
